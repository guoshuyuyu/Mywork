...
void MainWindow::createUsersClient()

{
    centerFrame=new centerFrame();
...
void MainWindow::createToolBar ()
{
    ...
    QImage image(":/new/prefix1/tp.jpg");
    QImage targetRect(0,0,20,20);
    ...
    connect(saveBtn,&ToolButton::clicked,centerFrame,&CenterFrame::clearPaint);
